...
class AramaUygulamasi(QWidget):
    def __init__(self):
        super().__init__()
        self.initUI()

    def initUI(self):
        self.setWindowTitle('Arama Uygulaması')
        ...
        header_label.setText("Arama Uygulaması")
        ...
        self.google_arama_dugmesi = QPushButton('Google 🔍', self)
        self.google_arama_dugmesi.clicked.connect(self.google_arama_yap)
        self.google_arama_dugmesi.setStyleSheet("background-color: #4285f4; color: white; border: none; padding: 10px 20px; font-weight: bold;")

        self.youtube_arama_dugmesi = QPushButton('YouTube 🔍', self)
        self.youtube_arama_dugmesi.clicked.connect(self.youtube_arama_yap)
        self.youtube_arama_dugmesi.setStyleSheet("background-color: #FF0000; color: white; border: none; padding: 10px 20px; font-weight: bold;")

        button_layout.addWidget(self.google_arama_dugmesi)
        button_layout.addWidget(self.youtube_arama_dugmesi)
        ...
        bottom_layout.addWidget(kilavuz_dugmesi)
        bottom_layout.addWidget(discord_dugmesi)
        bottom_layout.addWidget(cikis_dugmesi)
    ...
    def kilavuz_goster(self):
        kilavuz_mesaji = (
            ...
            "<strong>Arama Uygulaması Kılavuzu</strong><br><br>"
            ...
            "2. İlgili arama düğmesine tıklayın. Bu, tarayıcınızda arama sonuçlarını açacaktır.<br><br>"
